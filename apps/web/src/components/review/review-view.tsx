                  ...
                  <div className="space-y-5">
                    {continueChapter ? (
                      <button
                        ...
                        className="flex w-full items-center gap-3 rounded-lg border border-primary/30 bg-primary/10 px-5 py-3.5 text-left transition-colors hover:bg-primary/15"
                      >
