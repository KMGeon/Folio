...
const chapter: ReviewChapter = {
  ...
  summary: "Summary",
  files: [
    { path: "a.ts", status: "added", additions: 1, deletions: 0, viewed: false },
    { path: "b.ts", status: "deleted", additions: 0, deletions: 1, viewed: true },
  ],
  diffLines: [
...
describe("buildFileScopedChapter", () => {
  it("keeps chapter metadata but only includes the selected file lines and file summary", () => {
    expect(buildFileScopedChapter(chapter, "b.ts")).toEqual({
      ...chapter,
      files: [{ path: "b.ts", status: "deleted", additions: 0, deletions: 1, viewed: true }],
